...
/** Deterministic pseudo-random in [0, 1) from string id (stable across runs). */
...
/**
 * Build a coarse grid of synthetic cells. Backend pair can swap for static JSON import.
 */
